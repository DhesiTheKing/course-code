...
import {assesmentContent } from "./AssesmentData";
...
const SignLanguageAssessment = ({assesmentType}) => {
  const assessment = assesmentContent();
...
export default SignLanguageAssessment;
